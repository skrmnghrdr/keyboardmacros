...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_tkl_ansi( //defualt key layer 
        ...
        KC_LCTL, KC_LGUI,  LT(2, KC_LALT),                        KC_SPC,                                KC_RALT,  KC_APP,   KC_RCTL,  MO(3)
    ),
    ...
    [3] = LAYOUT_tkl_ansi( //fn key layer (keyboard things)
        KC_PANIC,  KC_1,     KC_2,     KC_3,      KC_4,      KC_5,     KC_6,     KC_MPRV, MD_24G,  MD_BLE3,  TG(0),  MD_BLE1,  MD_BLE2,  U_EE_CLR,
